...
for nme in setofnames:
    ...
    while boo:
        try:
            ret=ssh.send_command("sh environment")
            boo=False
        except:
    ...
    dictofobj[nme].gennodedict['thermal_status']=
    dictofobj[nme].gennodedict['input_voltage']=
    dictofobj[nme].gennodedict['output_voltage']=
    dictofobj[nme].gennodedict['board_temperature']=
    dictofobj[nme].gennodedict['fan_status']=
    ...
    for interf in dictofobj[nme].dictint.keys():
        ...
        while boo:
            try:
                ret=ssh.send_command("sh int "+interf)
                boo=False
            except:
                print("Exception Raised 1, Trying again")
                boo=True
        ...
        dictofobj[nme].dictint[interf]['crc']=
        dictofobj[nme].dictint[interf]['runts']=
        dictofobj[nme].dictint[interf]['giants']=
        dictofobj[nme].dictint[interf]['throttles']=
        dictofobj[nme].dictint[interf]['frame']=
        dictofobj[nme].dictint[interf]['overrun']=
        dictofobj[nme].dictint[interf]['input_errors']=
        dictofobj[nme].dictint[interf]['watchdog']=
        dictofobj[nme].dictint[interf]['late_collision']=
        dictofobj[nme].dictint[interf]['output_errors']=
        dictofobj[nme].dictint[interf]['collisions']=
        dictofobj[nme].dictint[interf]['duplex']=
        dictofobj[nme].dictint[interf]['speed']=
        dictofobj[nme].dictint[interf]['mtu']=
        dictofobj[nme].dictint[interf]['bandwidth']=
        dictofobj[nme].dictint[interf]['line_protocol']=
        dictofobj[nme].dictint[interf]['dll_status']=
        dictofobj[nme].dictint[interf]['reliability']=
        dictofobj[nme].dictint[interf]['txload']=
        dictofobj[nme].dictint[interf]['rxload']=
